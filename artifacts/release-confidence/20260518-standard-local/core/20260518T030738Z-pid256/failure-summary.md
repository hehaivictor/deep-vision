...
- 来源摘要: `harness:20260518T030738Z-pid256 stages=doctor/observe`
- 预览模板: `python3 scripts/agent_scenario_scaffold.py --source harness --run-dir '/Users/hehai/Documents/开目软件/Agents/project/DeepVision/artifacts/release-confidence/20260518-standard-local/core/20260518T030738Z-pid256' --name ops-incident-20260518 --category ops --budget-ms 120000 --output tests/harness_scenarios/ops/ops-incident-20260518.json --tag incident --tag manual --tag ops --tag harness --dry-run`
- 直接写入: `python3 scripts/agent_scenario_scaffold.py --source harness --run-dir '/Users/hehai/Documents/开目软件/Agents/project/DeepVision/artifacts/release-confidence/20260518-standard-local/core/20260518T030738Z-pid256' --name ops-incident-20260518 --category ops --budget-ms 120000 --output tests/harness_scenarios/ops/ops-incident-20260518.json --tag incident --tag manual --tag ops --tag harness`
