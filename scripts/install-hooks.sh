...
echo "  - pre-commit 自动拦截仅提交 version.json 或同版本重复编辑"
...
echo ""
echo "覆盖防重复检查（仅在确有必要时使用）："
echo "  ALLOW_VERSION_ONLY_COMMIT=1 git commit -m \"更新版本说明\""
echo "  ALLOW_SAME_VERSION_EDIT=1 git commit -m \"修订同版本描述\""
echo ""
